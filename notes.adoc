...
The output of `dissassembly <function nam>` might look something like this
...
You can see what is insdide the memory address `0x404028` with
...
As you can see that address is where `msg` is located
