...
The address is not stored in the stack (for rip contents) is called *return*
*address*.

the first size arguments are rdi, rsi, rdx, rcx, r8, and r9, respectively.
...
Register::
    Use teh value in teh specified register
